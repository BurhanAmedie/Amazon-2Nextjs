    ...
    return (
        <header>
            <div className="flex items-center bg-amazon_blue p-2 flex-grow py-2">
                ...
                {/* Search box */}
                    <div className="hidden sm:flex item center h-10 rounded-md flex-grow cursor-pointer bg-yellow-400 hover:bg-yellow500">
                ...
                <div className="text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap">
                    ...
                    className="link relative flex items-center">
                        ...
                        <p className=" hidden md:inline mt-2 font-extrabold md:text-sm">{items.length}</p>
                    </div>
                </div>
